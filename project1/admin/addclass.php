    ...
    <div class="col-sm-12 top"></div>
              <div class="col-sm-12 head"><i class="fa fa-user-shield" style="font-size:45px; color:black;"></i>ADMIN WORKSPACE</div>
                <div class="col-sm-2 left">
                 ...
                 <div class="col-sm-10">
                    <div class="box_head">
                        <p><i class="fa fa-school" style="font-size:45px; color:black;"></i>ADD CLASS</p>
                    </div>
                            ...
                            <div class="col-sm-8">   
                              ...
                              <div class="form-group">
                                ...
                                <div style="text-align:center;">
                                    <input class="form-submit-button" type="submit" name="submit" id="submit" onclick="addclass();">
                                </div>
                            </div>
                            <div class="col-sm-2"></div>
                            </form>
